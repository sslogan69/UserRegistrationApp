...
namespace UserRegistrationApp.Migrations
{
    ...
    [Migration("20250305220028_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UserRegistrationApp.DbContext.User", b =>
                {
            ...
            modelBuilder.Entity("UserRegistrationApp.DbContext.WorkflowState", b =>
                {
            ...
            modelBuilder.Entity("UserRegistrationApp.DbContext.WorkflowState", b =>
                {
                    b.HasOne("UserRegistrationApp.DbContext.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
